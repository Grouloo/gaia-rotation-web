...
export type FranceDepartments = typeof FranceDepartments
export type FranceDepartment = FranceDepartments[keyof FranceDepartments]
export enum Culture {
	WEAT = 'Blé',
}
...
export type FarmInformationForm = {
